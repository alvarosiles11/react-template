...
class Perfil extends Component {
    ...
    getHeader() {
        ...
        return <SView col={"xs-12"} height={200} center row backgroundColor={STheme.color.card}>
            ...
            <SHr height={20} />
            <SView col={"xs-11"} height={80}>

                <SView col={"xs-12"} height row >
                    <SView col={"xs-2.5 sm-2 md-2 lg-2"} center>
                        <SView style={{
                            width: 70,
                            height: 70,
                    ...
                    <SView col={"xs-9.5 sm-9 md-9 lg-9"}    >
                        <SView height center col={"xs-12"} >
                                 <SText fontSize={14} col={"xs-11 md-12"} color={STheme.color.lightBlack} >{"Ingresa tu nombre y añade una foto del perfil (opcional)."}</SText>
                         </SView>
                    </SView>
                </SView>
            </SView>
            ...
            <SView col={"xs-11"} height={30}   >
                <SView col={"xs-2.5 sm-2 md-2 lg-2"} height center  >
                    <SText fontSize={18}  style={{ color: 'blue' }}>Editar</SText>
                </SView>
            </SView>

            <SHr height={15} />

            <SView col={"xs-12"} center height={40} row  >
                <SView col={"xs-0.5"} >
                </SView>
                <SView flex height center  >
                    <SHr height={1} color={STheme.color.secondary + "33"} />
                     <SText height fontSize={18} col={"xs-12"} bold>Brian Baldivieso 🕉️ 🇨🇵</SText>
                     <SHr height={1} color={STheme.color.secondary + "33"} />
                </SView>
            </SView>
            <SHr height={20} />
    ...
    render() {
        ...
        return (
            <SPage hidden>
                <BarraSuperior duration={500} title={"configuracion"} goBack={() => {
                    SNavigation.goBack()
                }} />

                {/* <SText>Perfil de usuario</SText> */}
